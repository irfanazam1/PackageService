package com.ciklum.services.packageservice.model;

import com.ciklum.services.packageservice.controller.PackageServiceController;
...
public class PackageInfo extends RepresentationModel<PackageInfo> {
    ...
    public void addLinks(){
        add(linkTo(methodOn(PackageServiceController.class).getAllPackages()).withRel("packages"));
